...
import { Plus, CheckCircle2, Clock, Loader2, Undo2 } from "lucide-react";
    ...
    <div className="w-full">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 py-4">
        ...
        <div className="flex flex-wrap items-center gap-4 flex-1 min-w-[200px]">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <SelectContent>
                {["personal","sponsor","study","rent","flight reservation","medical","bank statements"].map(cat => (
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {/* Bulk Actions Dropdown (only visible when something is selected) */}
          {selectedRowCount > 0 && (
            <DropdownMenu>
          ...
          {/* Restore All button (always outside) */}
          {hasSoftDeleted && (
            <Button onClick={onRestoreAllClick} className="flex items-center whitespace-nowrap" variant="outline">
